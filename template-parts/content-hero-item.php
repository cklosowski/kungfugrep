			...
			<div class="hero-text">
				...
				<div class="hero-date">
					...
					<span class="vcard author">
						<span class="post-author fn"><?php echo esc_html( get_the_author_meta( 'display_name', $author_id ) ); ?></span>
					</span>
					<span class="hero-on-span"><?php esc_html_e( 'on', 'paperback' ); ?></span>
					<span class="hero-date-span post-date updated"><?php echo get_the_date(); ?></span>
				</div>
			</div><!-- .photo-overlay -->
		</div><!-- .container -->
	</div>
